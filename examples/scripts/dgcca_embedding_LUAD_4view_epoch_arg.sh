### This script is made to run on google colab, and takes as an argument a 4 view dataframe, so I don't have to make a new script every time a new dataframe is made ###
start_epoch=1
end_epoch=5
