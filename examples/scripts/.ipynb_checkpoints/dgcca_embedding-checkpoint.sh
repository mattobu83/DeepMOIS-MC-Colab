...
# # Raw data
IN_PATH="${IN_DIR}/methyl_rnaseq_mirna_minmax1.tsv"
NO_OF_VIEWS=3
...
echo "python ../dgcca_train_harness.py --input ${IN_PATH} --n ${NO_OF_VIEWS}

python ../dgcca_train_harness.py --input ${IN_PATH} --n ${NO_OF_VIEWS}
